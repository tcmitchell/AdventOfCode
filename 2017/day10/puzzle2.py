...
def main(argv):
    datafile = argv[1]
    bites = load_input(datafile)
    aoc_hash = compute_hash(bites)
    print('Hash for %r: %r' % (bites, aoc_hash))
